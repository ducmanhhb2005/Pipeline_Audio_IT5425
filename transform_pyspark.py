...
def process_partition(iterator):
    ...
    """
    # Khởi tạo kết nối MinIO bên trong worker
    import io
    import numpy as np
    import librosa
    from minio import Minio
    ...
    # Duyệt qua danh sách file trong partition này
    for row in iterator:
...
# Đọc Metadata Extract
# giả lập tải CSV về rồi đọc vào Spark.
...
# Tăng số partitions để tận dụng đa luồng 
# máy có 8 core, chia thành 16 phần để chạy song song
...
# Chuyển sang Pandas để ghi file duy nhất
df_pandas = df_final.toPandas()
df_pandas.to_csv(output_csv_path, index=False)

# Upload ngược lại MinIO bằng Python client
